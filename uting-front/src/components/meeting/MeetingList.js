                ...
                <div style={{ marginRight: "25px" }}>
                    <Container className="MeetingRoom">
                        <Row style={{ width: "100%" }}>
                            ...
                            <Col xs="3">
                            {room.maxNum*2===room.numOfMan+room.numOfWoman? <button className="joinBtn2" onClick={() => canAttend(room)}>미팅중</button>:<button className="joinBtn" onClick={() => canAttend(room)}>참가</button>}
